...
describe('UserController', () => {
  ...
  describe('getCurrentUser', () => {
    it('should return current user profile', async () => {
      ...
      vi.spyOn(userController as any, 'findUserById').mockResolvedValue(
        mockUser,
      )
  ...
  describe('updateProfile', () => {
    it('should update user profile successfully', async () => {
      ...
      vi.spyOn(userController as any, 'updateUserProfile').mockResolvedValue(
        mockUser,
      )
  ...
  describe('changePassword', () => {
    it('should change password successfully', async () => {
      ...
      vi.spyOn(userController as any, 'validatePassword').mockResolvedValue(
        true,
      )
      vi.spyOn(userController as any, 'updateUserPassword').mockResolvedValue(
        undefined,
      )
  ...
  describe('updateWalletAddress', () => {
    it('should update wallet address successfully', async () => {
      ...
      vi.spyOn(userController as any, 'updateUserWallet').mockResolvedValue(
        mockUser,
      )

      await userController.updateWalletAddress(
        mockRequest as Request,
        mockResponse as Response,
      )
  ...
  describe('isValidStellarAddress', () => {
    it('should validate correct Stellar address', () => {
      ...
      expect((userController as any).isValidStellarAddress(validAddress)).toBe(
        true,
      )
    })
    ...
    it('should reject invalid Stellar address', () => {
      ...
      expect(
        (userController as any).isValidStellarAddress(invalidAddress),
      ).toBe(false)
    })

    it('should reject address with wrong length', () => {
      const shortAddress = 'GABC123'
      expect((userController as any).isValidStellarAddress(shortAddress)).toBe(
        false,
      )
    })
  })
